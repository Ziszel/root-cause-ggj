...
public class Book : MonoBehaviour {
    ...
    void Start()
    {
        ...
        //currentPage = GameManager.Instance.GetBookPage(0);
    }
    ...
    {
        if (mode == FlipMode.RightToLeft)
            currentPage = GameManager.Instance.AddBookPage(2);
        else
            currentPage = GameManager.Instance.AddBookPage(-2);
        Debug.Log("currentPage:" + GameManager.Instance.GetBookPage());
        GetBookInformation();
        LeftNext.transform.SetParent(BookPanel.transform, true);
        Left.transform.SetParent(BookPanel.transform, true);
        LeftNext.transform.SetParent(BookPanel.transform, true);
    ...
    public List<string> LeftStrings1 = new List<string>();
    public List<string> LeftStrings2 = new List<string>();
    public List<string> LeftStrings3 = new List<string>();
    public List<string> RightStrings1 = new List<string>();
    public List<string> RightStrings2 = new List<string>();
    public List<string> RightStrings3 = new List<string>();

    public void GetBookInformation()
    {
        currentPage = GameManager.Instance.GetBookPage();
        //OpenInformationPanel();
        switch (currentPage)
        {
            case 0:
    ...
    public void Close()
    {
        ...
        PersonInformationPanel.SetActive(false);
    ...
    {
        PersonInformationPanel.SetActive(true);
    }
}
